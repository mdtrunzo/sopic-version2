...
function MemoriasFour({
  ...
  return (
    <>
      <div className="flex flex-col pt-6 w-full pdf-export memorias-four">
        <div className="w-full flex flex-col ">
          ...
          <div className="flex w-full">
            ...
            <div className="w-[225px] h-[70px] flex flex-col justify-center items-center m-1 black-heart">
          ...
          <div className="flex w-full"> 
            ...
            <div className="w-[70px] h-[70px] flex flex-col justify-center items-center m-1 black-heart"></div>
            <div className="w-[70px] h-[70px] flex flex-col justify-center items-center m-1 black-heart"></div>
            <div className="w-[70px] h-[70px] flex flex-col justify-center items-center m-1 black-heart"></div>
            <div style={{ overflow: 'hidden' }} className='one'>
              <div
