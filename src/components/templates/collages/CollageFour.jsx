...
function CollageFour({ handleId, arr, showError, showErrorLess, showSuccess }) {
  ...
  return (
    <>
      <div className="flex flex-col pt-6 w-full collage-four pdf-export">
        {/* FIRST ROW */}
        <div className="w-full flex h-28 mb-2">
          <div style={{ overflow: 'hidden' }} className="one">
            <div
              style={{ backgroundImage: `url(${img})` }}
              className="w-28 h-28 m-2 bg-cover flex justify-center flex-col"
              type="img"
              id="1"
              onClick={(e) =>
        ...
        {/* SECOND ROW */}
        <div className="w-full flex h-28 mb-2 one" >
        ...
        <div>
          <div className="kids-header flex justify-center items-center mt-8">
