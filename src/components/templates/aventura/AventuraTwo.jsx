...
function AventuraTwo({ handleId, arr, showError, showErrorLess, showSuccess }) {
  ...
  return (
    <>
      <div className="flex flex-col pt-6 w-full pdf-export aventura-two">
        {/* FIRST ROW */}
