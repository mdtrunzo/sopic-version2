...
import '../styles/KidsThree.css'
import { drawDOM, exportPDF } from '@progress/kendo-drawing'

function KidsThree({ handleId, arr, showError, showErrorLess, showSuccess }) {
  const [img, setImg] = useState(IMG)
  const [text, setText] = useState(arr.title)
  const [text2, setText2] = useState(arr.subtitle)
  const [text3, setText3] = useState(arr.text)
  ...
  return (
    <>
      <div className="kids kids-three pt-9 pdf-export">
        ...
        <div className="flex w-full mx-auto p-8 pt-3">
          <div className="flex flex-col px-20">
            <div className="border-solid border-2 border-b border-[#527f89] px-5">
              <h2
                id="3"
                style={{ fontSize: '30px' }}
            ...
            <p
              ...
              id="5"
              onClick={(e) => handleId(e.target.id)}
              className="text-center border-solid border-2 border-t border-[#527f89]"
            >
              <EditText
                value={text3}
